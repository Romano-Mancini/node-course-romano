...
/**
 * User gets suggestions generated by an LLM
 */
export const getSuggestions = <ThrowOnError extends boolean = false>(options?: Options<GetSuggestionsData, ThrowOnError>): RequestResult<GetSuggestionsResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetSuggestionsResponses, unknown, ThrowOnError>({
    security: [{ name: 'x-auth', type: 'apiKey' }],
